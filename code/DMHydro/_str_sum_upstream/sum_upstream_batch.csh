...
sbatch --mem=54000 --cpus-per-task=1 --job-name=${SCENARIO} --dependency=singleton --nodes=4 --mincpus=36 --ntasks=144 --ntasks-per-node=36 sum_upstream_steps.csh ${SCENARIO}
