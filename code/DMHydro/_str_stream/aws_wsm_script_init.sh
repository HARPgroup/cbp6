...
mkdir /scratch/$project/tmp/$uname-scratch/CalCAST01DB
cp -p /modeling/$project/config/catalog/geo/CalCAST01/comids.db /scratch/$project/tmp/$uname-scratch/CalCAST01DB/
echo "BHATT1 `hostname` `pwd` `ls -al /scratch/$project/tmp/$uname-scratch/CalCAST01DB/`"
echo "BHATT2 `hostname` `pwd` `ls -al `"
