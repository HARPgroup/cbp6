...
container='C:\\Users\\emma\\Documents\\HARP\\cbp6\\code';

# Sourcing functions

source(paste0(container,"/cbp6_functions.R"))
source(paste0(container,"/function_holder.R"))
...
---
title: "Appendix C.13: River Segment `r paste(riv.seg,': ',mod.scenario1," vs. ", mod.scenario2)`"
header-includes:
  - \usepackage{titling}
...
scale_colour_manual(values=c("black","red"))+
  ...
  annotate("text", x=xpos1, y=max, label= paste0('Difference:', '',difference1, '', '%'), size=5)+
...
myplot <- ggplot(df, aes(x=Date)) + 
  geom_line(aes(y=Scenario1, color=name_scenario1), size=0.5) +
  geom_line(aes(y=Scenario2, color=name_scenario2), size=0.5)+
  fixtheyscale+
  theme_bw()+ 
  theme(legend.position="top", 
        legend.title=element_blank(),
...
options(scipen=5, width = 1400, height = 950)
myplot <- ggplot(df, aes(x=Date)) + 
  geom_line(aes(y=Scenario1, color=name_scenario1), size=0.7) +
  geom_line(aes(y=Scenario2, color=name_scenario2), size=0.7)+
  fixtheyscale+ 
  theme_bw()+ 
  theme(legend.position="top", 
        legend.title=element_blank(),
...
options(scipen=5, width = 1400, height = 950)
myplot <- ggplot(df, aes(x=Date)) + 
  geom_line(aes(y=Scenario1, color=name_scenario1), size=0.8) +
  geom_line(aes(y=Scenario2, color=name_scenario2), size=0.8)+
  fixtheyscale+ 
  theme_bw()+ 
  theme(legend.position="top", 
        legend.title=element_blank(),
...
options(scipen=5, width = 1400, height = 950)
myplot <- ggplot(df, aes(x=Date)) + 
  geom_line(aes(y=Scenario1Baseflow, color=name_scenario1), size=0.5) +
  geom_line(aes(y=Scenario2Baseflow, color=name_scenario2), size=0.5)+
  fixtheyscale+ 
  theme_bw()+ 
  theme(legend.position="top", 
        legend.title=element_blank(),
...
options(scipen=5, width = 1400, height = 950)
myplot <- ggplot(df, aes(x=Date)) + 
  geom_line(aes(y=Scenario1Flow, color=paste("Scenario 1 Flow")), size=1)+
  geom_line(aes(y=Scenario2Flow, color=paste("Scenario 2 Flow")), size=0.5)+ 
  geom_line(aes(y=Scenario1Baseflow, color=paste("Scenario 1 Baseflow")), size=0.5) +
  geom_line(aes(y=Scenario2Baseflow, color=paste("Scenario 2 Baseflow")), size=1)+
  fixtheyscale+ 
  theme_bw()+ 
  theme(legend.position="top", 
        legend.title=element_blank(),
...
options(scipen=5, width = 1400, height = 950)
myplot <- ggplot(df, aes(x=Date)) + 
  geom_point(aes(y=Residual, color=name_scenario1), size=1) +
  geom_line(aes(y=Zeroline, color=name_scenario2), size=0.8)+
