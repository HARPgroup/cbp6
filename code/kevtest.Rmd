...
cbp6_link <- "C:\\Users\\emma\\Documents\\HARP\\Github\\cbp6";
...
container1 ="C:\\Users\\emma\\Documents\\HARP\\Github";
container2 = "C:\\Users\\emma\\Documents\\HARP\\Github\\cbp6\\code";
...
---
title: "Appendix ##: River Segment: `r paste(riv.seg,': ','Base 2018:',mod.scenario1," vs. Climate Change: ", mod.scenario2)`"
header-includes:
  - \usepackage{titling}
...
scale_colour_manual(values=c("black","red"))+
  ...
  annotate("text", x=xpos1, y=1.05*max, label= paste0('Difference:', '',difference1, '', '%'), size=3.25)+
...
difference2plot <- ggplot(df, aes(x=Date)) + 
  ...
  scale_colour_manual(values=c("black","red"))+
  guides(colour = guide_legend(override.aes = list(size=5)))+
  annotate("text", x=xpos1, y=1.05*max, label= paste0('Difference:', '',difference2, '', '%'), size=3.25)+
  annotate("text", x=xpos2, y=1.05*max, label= paste0('Date Range: ', '', 
...
difference3plot <- ggplot(df, aes(x=Date)) + 
  ...
  scale_colour_manual(values=c("black","red"))+
  guides(colour = guide_legend(override.aes = list(size=5)))+
  annotate("text", x=xpos1, y=1.05*max, label= paste0('Difference:', '',difference3, '', '%'), size=3.25)+
  annotate("text", x=xpos2, y=1.05*max, label= paste0('Date Range: ', '', 
