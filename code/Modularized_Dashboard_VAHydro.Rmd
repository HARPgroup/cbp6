...
# LOADING DATA ------------------------------------------------------------
  if (dat.source1 == 'vahydro') {
    print("Getting VAHydro data for source 1")
    ...
    print("Getting USGS gage data for source 1")
  ...
  if (dat.source2 == 'vahydro') {
    print("Getting VAHydro data for source 2")
    ...
    print("Getting USGS gage data for source 2")
