...
params: 
  ...
  dat.source2: 'gage' #'vahydroR', 'gage', or 'cbp_model'
...
scenprop2 <- get.scen.prop(riv.seg, mod.scenario2, 'vahydro', run.id2, start.date, end.date, site, token)
#if doing gage data change 'dat.source2' to 'vahydro
