...
# LOADING DATA ------------------------------------------------------------
  if (dat.source1 == 'vahydro') {
    warning("Getting VAHydro data for source 1")
    ...
    warning("Getting USGS gage data for source 1")
    data1 <- gage_import_data_cfs(gage_number, start.date, end.date)
    scenprop1 <- get.scen.prop(riv.seg, 'usgs-1.0', 'vahydro', run.id = 'weighted', start.date, end.date, site, token)
  ...
  if (dat.source2 == 'vahydro') {
    warning("Getting VAHydro data for source 2")
    ...
    warning("Getting USGS gage data for source 2")
    data2 <- gage_import_data_cfs(gage_number, start.date, end.date)
    scenprop2 <- get.scen.prop(riv.seg, 'usgs-1.0', 'vahydro', run.id = 'weighted', start.date, end.date, site, token)
