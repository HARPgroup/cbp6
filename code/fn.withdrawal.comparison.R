withdrawal.comparison <- function(riv.seg) {
  ...
  p5.discharge <- read.csv(paste0('/opt/model/p53/p532c-sova/out/river/p532cal_062211/eos/ps_sep_div_ams_p532cal_062211_', riv.seg, '_3000.csv'))
  p6.discharge <- read.csv(paste0('/opt/model/p6/p6_gb604/out/river/CFBASE30Y20180615/eos/ps_sep_div_ams_CFBASE30Y20180615_', riv.seg, '_3000.csv'))
  ...
  p5.withdrawal <- read.csv(paste0('/opt/model/p53/p532c-sova/out/river/p532cal_062211/eos/ps_sep_div_ams_p532cal_062211_', riv.seg, '_3007.csv'))
  p6.withdrawal <- read.csv(paste0('/opt/model/p6/p6_gb604/out/river/CFBASE30Y20180615/eos/ps_sep_div_ams_CFBASE30Y20180615_', riv.seg, '_3007.csv'))
  ...
  p5.ag.withdrawal <- read.csv(paste0('/opt/model/p53/p532c-sova/out/river/p532cal_062211/eos/ps_sep_div_ams_p532cal_062211_', riv.seg, '_3008.csv'))
  p6.ag.withdrawal <- read.csv(paste0('/opt/model/p6/p6_gb604/out/river/CFBASE30Y20180615/eos/ps_sep_div_ams_CFBASE30Y20180615_', riv.seg, '_3008.csv'))
